...
export default function PublicPage() {
  return <main className="public-site">
    <header className="public-nav">
      <a className="public-logo" href={`${BASE_PATH}/`}><span>JJ</span><b>JAY JOHNSON</b></a>
      <nav><a href="#about">About</a><a href="#work">The work</a><a href={`${BASE_PATH}/app`}>Wellness app</a></nav>
      <a className="public-nav-cta" href={`${BASE_PATH}/app?tab=connect`}>Connect <span>↗</span></a>
    </header>
    ...
    <section className="public-hero">
      ...
      <div className="public-hero-copy">
        ...
        <div><a className="public-primary" href={`${BASE_PATH}/app?tab=connect`}>Start a connection <span>↗</span></a><a className="public-secondary" href={`${BASE_PATH}/app`}>Open Jay Connect</a></div>
      </div>
      <div className="public-portrait"><img src={`${BASE_PATH}/welgen-leadership.jpeg`} alt="Jay Johnson" /><span>CONNECTOR · AMBASSADOR · BUILDER</span></div>
    </section>
    ...
    <section className="public-story">
      <div className="story-image"><img src={`${BASE_PATH}/community-leadership.jpeg`} alt="Jay Johnson at a community event" /></div>
    ...
    <section className="public-products">
      ...
      <a className="product-card app-card" href={`${BASE_PATH}/app`}><span>FOR THE COMMUNITY</span><h3>Jay Connect</h3><p>Wellness resources, Jay&apos;s story and a guided way to ask for help, volunteer or partner.</p><b>Open the PWA ↗</b></a>
      <a className="product-card dash-card" href={`${BASE_PATH}/dashboard`}><span>CLIENT VIEW</span><h3>Professional dashboard</h3><p>A clean operational overview of connections, programs, partnerships and next actions.</p><b>View dashboard ↗</b></a>
    </section>

    <section className="public-cta"><p>READY TO CONNECT?</p><h2>Bring the need.<br />Bring the resource.<br /><em>Let&apos;s build the bridge.</em></h2><a href={`${BASE_PATH}/app?tab=connect`}>Start here <span>↗</span></a></section>
    <footer className="public-footer"><a className="public-logo" href={`${BASE_PATH}/`}><span>JJ</span><b>JAY JOHNSON</b></a><p>Community · Wellness · Connection</p><span>Atlanta, Georgia · © 2026</span></footer>
  </main>;
}
