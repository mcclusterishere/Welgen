...
export default function DashboardPage() {
  return <main className="dashboard-shell">
    <aside className="dash-sidebar">
      <a className="dash-brand" href={`${BASE_PATH}/`}><span>JJ</span><div><b>JAY JOHNSON</b><small>OPERATIONS</small></div></a>
      <nav><a className="active" href="#overview"><i>⌂</i>Overview</a><a href="#pipeline"><i>⇄</i>Connections</a><a href="#partners"><i>◎</i>Partnerships</a><a href={`${BASE_PATH}/app`}><i>♡</i>Jay Connect app</a></nav>
      <div className="dash-profile"><img src={`${BASE_PATH}/welgen-leadership.jpeg`} alt="" /><div><b>Jay Johnson</b><span>Community connector</span></div><i>•••</i></div>
    </aside>

    <div className="dash-main">
      <header className="dash-header"><div><span>CLIENT DASHBOARD</span><h1>Good afternoon, Jay.</h1></div><div><a href={`${BASE_PATH}/`}>View public page ↗</a><button>＋ New connection</button></div></header>
      ...
      <section className="dash-grid">
        ...
        <div className="actions-panel"><div className="panel-head"><div><span>QUICK ACTIONS</span><h2>Keep moving</h2></div></div><a href={`${BASE_PATH}/app?tab=connect`}><i>＋</i><div><b>Open connection intake</b><span>Review the public flow</span></div><em>↗</em></a><a href="https://app.formdr.com/practice/NDA4MjA=/form/4SwPxMEauV-yK4wEmZP39IJPxbZ0H4wk" target="_blank" rel="noreferrer"><i>♡</i><div><b>Welgen patient intake</b><span>Open secure form</span></div><em>↗</em></a><a href={`${BASE_PATH}/`}><i>□</i><div><b>Share public profile</b><span>Client-ready link</span></div><em>↗</em></a></div>
      </section>
